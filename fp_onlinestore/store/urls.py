...
from .views import test_view, NotebookDetailView, NotebookListView, SmartphoneListView, SmartphoneDetailView, ProductsListView
...
urlpatterns = [
    ...
    path('products/base', ProductsListView.as_view(), name='products_list')
]
